        ...
        <tr>
          ...
          <td>
            <div class="row justify-content-center">
              <form action="kisiduzenle.php" method="POST" accept-charset="utf-8">
                <input type="hidden" name="kisi_id" value="<?php echo $kisibilgisi['kisi_id']?>">
              ...
              <form class="mx-1" action="islemler/ajax.php" method="POST" accept-charset="utf-8">
                <input type="hidden" name="kisi_id" value="<?php echo $kisibilgisi['kisi_id']?>">
                <button type="submit" name="kisisilme" class="btn btn-danger btn-sm btn-icon-split">
                  <span class="icon text-white-60">
                    <i class="fas fa-trash"></i>
                  </span>
                </button>
              </form>
              <form action="kisidetay.php" method="POST" accept-charset="utf-8">
                <input type="hidden" name="kisi_id" value="<?php echo $kisibilgisi['kisi_id']?>">
